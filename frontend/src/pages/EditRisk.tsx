  ...
  useEffect(() => {
    if (risk) {
      setFormData({
        ...
        // Control Management Fields - Updated naming
        preventative_controls_coverage: risk.preventative_controls_coverage,
        preventative_controls_effectiveness: risk.preventative_controls_effectiveness,
        preventative_controls_description: risk.preventative_controls_description || '',
        detective_controls_coverage: risk.detective_controls_coverage,
        detective_controls_effectiveness: risk.detective_controls_effectiveness,
        detective_controls_description: risk.detective_controls_description || '',
        corrective_controls_coverage: risk.corrective_controls_coverage,
        corrective_controls_effectiveness: risk.corrective_controls_effectiveness,
        ...
        business_disruption_impact_rating: risk.business_disruption_impact_rating,
        business_disruption_impact_description: risk.business_disruption_impact_description,
        business_disruption_likelihood_rating: risk.business_disruption_likelihood_rating,
        business_disruption_likelihood_description: risk.business_disruption_likelihood_description,
        ...
        financial_impact_notes: risk.financial_impact_notes || '',
